    ...
    try{
		...
		try {   
		  ...
		  try{
			...
			embeduserinfo.setAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: member.user.tag}), member.user.displayAvatarURL({ dynamic: true }), "https://https://discord.gg/hx2wg4HfQS")
			...
			embeduserinfo.setAuthor(handlemsg(client.la[ls].cmds.info.userinfo.author, { usertag: user.tag}), user.displayAvatarURL({ dynamic: true }), "https://https://discord.gg/hx2wg4HfQS")
...
/**
  * @INFO
  * Bot Coded by S409™#0001 | https://github?.com/S409™/Discord-Js-Handler-Template
  * @INFO
