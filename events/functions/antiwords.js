const antiwordsData = require('../../database/guildData/antiwords')
  module.exports = async (message) => {
    ...
    if (antiwords) {
      if (message.content.match("bitch") || message.content.match("hoe") || message.content.match("slut") || message.content.match("nigga") || message.content.match("nigg") || message.content.match("dick") || message.content.match("cunt") || 
      message.content.match("penis") ||
      message.content.match("asshole") ||
      message.content.match("fadget") ||
      message.content.match("bitch") ||
      message.content.match("cunt") ||
      message.content.match("crap") ||
      message.content.match("penis") ||
      message.content.match("spastic") ||
