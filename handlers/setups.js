   ...
   let stateswitch = false;
    client.on("ready", () => {
        setInterval(() => {
            ...
            if (stateswitch) client.user.setActivity(`${config.prefix}help | s409.eu`, { type: "PLAYING" });
    ...
    function getAll(client, guild) {    
        const embed = new MessageEmbed()
            ...
            .setTitle('Help Menu - THANKS FOR INVITING ME!')
                ...
                >>> <@544245657230245888> \`S409™#9685\` [\`Website\`](https://musicium.eu) [\`INVITE\`](https://discord.com/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands)
                `)
