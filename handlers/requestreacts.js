      ...
      try {
        ...
        if (player && channel.id !== player.voiceChannel)
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle("<:cross:899255798142750770> I am already playing somewhere else!")
        ...
        switch (reaction.emoji.name) {
          ...
          case "⏭":
            ...
            if (client.settings.get(message.guild.id, `djroles`).toString() !== "") {
              ...
              if (player.queue.size == 0) {
                ...
                return message.channel.send(new MessageEmbed()
                  .setTitle("<:tick:899255869185855529> ⏹ Stopped and left your Channel")
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              }
              ...
              //send success message
              return message.channel.send(new MessageEmbed()
                .setTitle("<:tick:899255869185855529> ⏭ Skipped to the next Song")
                .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                .setFooter(es.footertext, es.footericon)
              );
            }
          ...
          case "♾":
            ...
            //Send Success Message
            message.channel.send(new MessageEmbed()
              .setTitle(`<:tick:899255869185855529> ${player.get("autoplay") ? `\`✔️ Enabled\`` : `\`❌ Disabled\``} Autoplay`)
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              .setFooter(es.footertext, es.footericon)
            ).then(async msg => {
              try {
