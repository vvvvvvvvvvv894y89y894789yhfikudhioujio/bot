      ...
      try {
        ...
        if(channel && channel.permissionsFor(channel.guild.me).has(Permissions.FLAGS.SEND_MESSAGES)){
          ...
          collector.on('collect', async i => {
              ...
              if (!player)
                return i?.reply({content: "<:Nope:939617068754550907> Nothing Playing yet", ephemeral: true})
...
/**
* @INFO
* Bot Coded by S409™#0001 | https://github?.com/S409™/discord-js-lavalink-Music-Bot-erela-js
* @INFO
