...
module.exports = async (client, message, args, type) => {
  ...
  if (!permissions.has("CONNECT"))
    return message.channel.send(new MessageEmbed()
      ...
      .setTitle("<:cross:899255798142750770> I need permissions to join your channel")
    );
  if (!permissions.has("SPEAK"))
    return message.channel.send(new MessageEmbed()
      .setColor(ee.wrongcolor)
      .setFooter(ee.footertext, ee.footericon)
      .setTitle("<:cross:899255798142750770> I need permissions to speak in your channel")
    );
  ...
  if (method[0] === "song")
    ...
    return message.channel.send(new MessageEmbed()
      .setColor(ee.wrongcolor)
      .setFooter(ee.footertext, ee.footericon)
      .setTitle("<:cross:899255798142750770> No valid search Term? ... Please Contact: `S409™#9685`")
    );
}
