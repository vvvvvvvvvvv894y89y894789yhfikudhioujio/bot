                    ...
                    if (!isOurInvite) {
                        ...
                        if (Number(countermap.get(message.author.id)) > 5) {
                            ...
                            message.channel.send(new MessageEmbed()
                                ...
                                .setTitle(`<:tick:899255869185855529> \`${member.user.tag}\` got **MUTED** for \`10 Minutes\``)
                            ...
                            return message.channel.send(new MessageEmbed()
                                ...
                                .setFooter(es.footertext, es.footericon)
                                .setTitle(`<:cross:899255798142750770> You are not allowed to send Discord related Links in this Channel`)
                            ).then(msg => msg.delete({
                                timeout: 3000
