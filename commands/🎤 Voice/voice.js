    ...
    try{
      ...
      if (cmd === "lock") {
        ...
        if (!channel) return message.reply(new Discord.MessageEmbed()
          .setColor(es.wrongcolor)
          .setTitle("<:cross:899255798142750770>  You have to be in a VoiceChannel, for this Command")
          .setFooter(es.footertext, es.footericon)
        )
        ...
        if (client.jointocreatemap.get(`tempvoicechannel_${message.guild.id}_${channel.id}`)) {
          ...
          if (!owner)
            return message.reply(new Discord.MessageEmbed()
              .setColor(es.wrongcolor)
              .setTitle("<:cross:899255798142750770>  You have to be the Owner of the **temp.** VoiceChannel!")
              .setFooter(es.footertext, es.footericon)
            )
          ...
          return message.reply(new Discord.MessageEmbed()
            .setColor(es.wrongcolor)
            .setTitle("<:cross:899255798142750770>  You have to be in a **temp.** VoiceChannel, for this Command!")
            .setFooter(es.footertext, es.footericon)
          )
        }
      } else if (cmd === "unlock") {
        ...
        if (client.jointocreatemap.get(`tempvoicechannel_${message.guild.id}_${channel.id}`)) {
          ...
          if (!args[0]) return message.reply(new Discord.MessageEmbed()
            .setColor(es.wrongcolor)
            .setTitle("<:cross:899255798142750770>  Please add a User via Ping / ID!")
          ...
          if (!member.voice.channel)
            return message.reply(new Discord.MessageEmbed()
              .setColor(es.wrongcolor)
              .setTitle("<:cross:899255798142750770>  Your pinged user, is not connected to a Channel")
              .setFooter(es.footertext, es.footericon)
            )
          if (member.voice.channel.id != channel.id)
            return message.reply(new Discord.MessageEmbed()
              .setColor(es.wrongcolor)
              .setTitle("<:cross:899255798142750770>  Your pinged user, is not connected in your Channel")
              .setFooter(es.footertext, es.footericon)
            )
          try {
            member.voice.kick();
            ...
            channel.createInvite().then(invite => {
              vc.updateOverwrite(member.user.id, {
                ...
                member.user.send(new Discord.MessageEmbed()
                  ...
                  return message.reply(new Discord.MessageEmbed()
                    .setColor(es.wrongcolor)
                    .setTitle(`<:cross:899255798142750770>  Error | Couldn't Dm \`${member.user.tag}\``)
                    .setDescription(`\`\`\`${String(JSON.stringify(e)).substr(0, 2000)}\`\`\``)
                    .setFooter(es.footertext, es.footericon)
                  )
                })
        ...
        if (client.jointocreatemap.get(`tempvoicechannel_${message.guild.id}_${channel.id}`)) {
          ...
          if (!args[0]) return message.reply(
            ...
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle("<:cross:899255798142750770>  You have to include the limit you want to set to")
          );
          if (isNaN(args[0])) return message.reply(
            new Discord.MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle("<:cross:899255798142750770>  You have to include the limit you want to set to | It MUST be a **Numer**")
          );
          ...
          if (userlimit > 99 || userlimit < 0) return message.reply(
            ...
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle("<:cross:899255798142750770>  Your included Number is not in the valid Range (`0` - `99`)")
          );
        ...
        if (client.jointocreatemap.get(`tempvoicechannel_${message.guild.id}_${channel.id}`)) {
          ...
          if (userlimit > maxbitrate || userlimit < 8000) return message.reply(
            ...
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle(`<:cross:899255798142750770>  Your included Number is not in the valid Range (\`8000\` - \`${maxbitrate}\`)`)
          );
