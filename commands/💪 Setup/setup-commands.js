  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      collector.on("collect", async b => {
        ...
        b?.reply(`<:Approved:939616742148308992> **\`Enabled ${enabled} Command-Categories\` and \`Disabled ${disabled} Command-Categories\` out of \`${b?.values.length} selected Command-Categories\`**`)
      })
