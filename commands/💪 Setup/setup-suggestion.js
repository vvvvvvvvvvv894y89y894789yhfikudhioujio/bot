  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      async function first_layer() {
        ...
        //define the embed
        let MenuEmbed = new MessageEmbed().setColor(es.color).setAuthor('Suggestion System', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/light-bulb_1f4a1.png', 'https://discord.gg/hx2wg4HfQS').setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-ticket"]["variable2"]))
        //send the menu msg
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<:Approved:939616742148308992> Accepted Idea! Expect this soon.`,
          denymsg: `<:Nope:939617068754550907> Thank you for the feedback, but we are not interested in this idea at this time.`,
