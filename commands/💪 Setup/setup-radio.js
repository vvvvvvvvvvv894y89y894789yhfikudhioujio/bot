      ...
      try{
        ...
        if (isNaN(args[0])) {
            return message.channel.send(new MessageEmbed()
              ...
              .setTitle(`<:cross:899255798142750770>  Not a valid radio station`)
        ...
        if (Number(args[1]) > 150 || Number(args[1]) < 1)
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(client.user.username, es.footericon)
            .setTitle(`<:cross:899255798142750770>  Volume Number out of Range`)
        ...
        //if not found send an error
          ...
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(client.user.username, es.footericon)
            .setTitle(`<:cross:899255798142750770>  Radio Station not found`)
