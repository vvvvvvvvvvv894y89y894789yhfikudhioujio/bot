    ...
    try {
      ...
      await tempmsg.channel.awaitMessages(m=>m.author.id == message.author.id, {
        ...
        .then(async collected => {
          ...
          if(channel){
            ...
            return message.reply(new Discord.MessageEmbed()
              .setTitle(`<:tick:899255869185855529> The Channel: \`${channel.name}\` is now registered as the Daily Fact Poster Channel`)
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          ...
          return message.reply(new Discord.MessageEmbed()
            .setTitle(`<:tick:899255869185855529> Disabled the Daily Fact Poster Channel`)
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<:tick:899255869185855529> Settings of the Daily Fact Poster Channel`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
