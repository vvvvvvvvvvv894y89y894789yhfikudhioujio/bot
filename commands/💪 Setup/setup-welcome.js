    ...
    try {
      ...
      if (temptype == "channel") {
          ...
          .then(async collected => {
                ...
                .then(collected => {
                  ...
                  if (channel) {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> The new Welcome Cannel is: \`${channel.name}\``)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            ...
            //Disable - CHANNEL
              ...
              try {
                ...
                return reaction.message.channel.send(new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> Disabled the Welcome **Message**`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                ...
                .then(async collected => {
                  ...
                  if (reaction.emoji.name === "1️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> I will now send no Image with the Welcome Message`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "2️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> I will now send an Image with the Welcome Message`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "6️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.frame") ? "Enabled the Frame for the Automated Welcome Image" : "Disabled the Frame for the Automated Welcome Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "7️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.discriminator") ? "Enabled the Discrimantor (4 Numbers with #) for the Automated Welcome Image" : "Disabled the Discrimantor (4 Numbers with #) for the Automated Welcome Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "8️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.membercount") ? "Enabled the MemberCount Text for the Automated Welcome Image" : "Disabled the MemberCount Text for the Automated Welcome Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "9️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.servername") ? "Enabled Servername Text Frame for the Automated Welcome Image" : "Disabled the Servername Text for the Automated Welcome Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "🔟") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.pb") ? "Enabled Profile Picture for the Automated Welcome Image" : "Disabled Profile Picture for the Automated Welcome Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  try {
                    ...
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<:tick:899255869185855529> The new Welcome Message is:`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            ...
            //Enable/Disable Invite Information - CHANNEL
              ...
              try {
                ...
                return reaction.message.channel.send(new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.invite") ? "Enabled Invite Information" : "Disabled INvite INformation"}`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          ...
          .then(async collected => {
            ...
            if (reaction.emoji.name === "1️⃣") {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> I will now send Welcome-Messages to a new User in his DMS`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
            ...
            //Disable - CHANNEL
              ...
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> I will now send **NO** Welcome-Messages to a new User in his DMS`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
                ...
                .then(async collected => {
                  ...
                  if (reaction.emoji.name === "1️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> I will now send no Image with the Welcome Message (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                  ...
                  if (reaction.emoji.name === "2️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> I will now send an Image with the Welcome Message (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                  ...
                  if (reaction.emoji.name === "6️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.framedm") ? "Enabled the Frame for the Automated Welcome Image" : "Disabled the Frame for the Automated Welcome Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                  ...
                  if (reaction.emoji.name === "7️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.discriminatordm") ? "Enabled the Discrimantor (4 Numbers with #) for the Automated Welcome Image" : "Disabled the Discrimantor (4 Numbers with #) for the Automated Welcome Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "8️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.membercountdm") ? "Enabled the MemberCount Text for the Automated Welcome Image" : "Disabled the MemberCount Textthe Automated Welcome Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "9️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.servernamedm") ? "Enabled Servername Text Frame for the Automated Welcome Image" : "Disabled the Servername Text for the Automated Welcome Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "🔟") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.pbdm") ? "Enabled Profile Picture for the Automated Welcome Image" : "Disabled Profile Picture for the Automated Welcome Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "welcome.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  try {
                    ...
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<:tick:899255869185855529> The new Welcome Message is: (DM)`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            ...
            //Enable/Disable Invite Information - CHANNEL
              ...
              try {
                ...
                return reaction.message.channel.send(new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.invitedm") ? "Enabled Invite Information" : "Disabled INvite INformation"}`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
        ...
        *React with the Right Emoji according to the Right action*`)
                ...
                .then(collected => {
                  ...
                  if (role) {
                    ...
                    if (welcomeroles.includes(role.id)) return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<:cross:899255798142750770>  ERROR | The role: \`${role.name}\` is already registered as an Welcome Role`)
                      .setColor(es.wrongcolor)
                      .setFooter(es.footertext, es.footericon)
                    );
                    client.settings.push(message.guild.id, role.id, "welcome.roles");
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<:tick:899255869185855529> The role: \`${role.name}\` is now registered as an Welcome Role`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  if (role) {
                    var welcomeroles = client.settings.get(message.guild.id, "welcome.roles")
                    if (!welcomeroles.includes(role.id)) return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<:cross:899255798142750770>  ERROR | The role: \`${role.name}\` is not registered as an Welcome Role yet`)
                      .setColor(es.wrongcolor)
                      .setFooter(es.footertext, es.footericon)
                    );
                    client.settings.remove(message.guild.id, role.id, "welcome.roles");
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<:tick:899255869185855529> Remove the role: \`${role.name}\` from the Welcome Roles`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                      .setDescription(`Everyone who joins will get those Roles now:\n<@&${client.settings.get(message.guild.id, "welcome.roles").join(">\n<@&")}>`.substr(0, 2048))
                      .setFooter(es.footertext, es.footericon)
                    );
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<:tick:899255869185855529> ${client.settings.get(message.guild.id, "welcome.captcha") ? "Enabled the Captcha System" : "Disabled the Cpatcha System"}`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
