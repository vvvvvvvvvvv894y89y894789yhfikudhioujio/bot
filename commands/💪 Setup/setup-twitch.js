    ...
    try {
      ...
      if (temptype == "set") {
        ...
        tempmsg = await tempmsg.edit({embed: new Discord.MessageEmbed()
          ...
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setDescription(`Please send me just the link, for example: \`https://www.twitch.tv/s409discordbot\``)
          .setFooter(es.footertext, es.footericon)
        })
                    ...
                    await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                      ...
                      .then(async collected => {
                        ...
                        if(msg){
                          ...
                          return message.reply(new Discord.MessageEmbed()
                            .setTitle("<:tick:899255869185855529> ADDED the USER to the STREAMER LIST ")
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<:cross:899255798142750770>  ERROR | THIS IS NOT FINISHED YET PLEASE STAND BY")
          .setColor(es.wrongcolor)
          .setDescription(`If you want to delete the USERS DM: \`S409™#9685\``.substr(0, 2000))
          .setFooter(es.footertext, es.footericon)
        );
        ...
        await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
          ...
          .then(collected => {
            ...
            if (message.content.toLowerCase() == "no") {
              ...
              return message.reply(new Discord.MessageEmbed()
                .setTitle(`<:tick:899255869185855529> Disabled the Twitch Logger System!`)
                .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                .setFooter(es.footertext, es.footericon)
              );
            }
            ...
            if (channel) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> I will now send all Twtich-logs into: \`${channel.name}\``)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
        ...
        await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
          ...
          .then(collected => {
            ...
            if (message.content.toLowerCase() == "no") {
              ...
              return message.reply(new Discord.MessageEmbed()
                .setTitle(`<:tick:899255869185855529> Disabled the Twitch Logger Role Granting!`)
                .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                .setFooter(es.footertext, es.footericon)
              );
            }
            ...
            if (channel) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> I will now give to all Streaming Members the Role: \`${channel.name}\``)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
        ...
        await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
          ...
          .then(collected => {
            ...
            if (message.content.toLowerCase() == "no") {
              ...
              return message.reply(new Discord.MessageEmbed()
                .setTitle(`<:tick:899255869185855529> Disabled the Twitch Logger Role PINGING!`)
                .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                .setFooter(es.footertext, es.footericon)
              );
            }
            ...
            if (channel) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> I will now ping the Role: \`${channel.name}\` when someone goes live`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
