...
*React with the Right Emoji according to the Right action*`).setFooter(es.footertext, es.footericon)
      ...
      if (temptype == "set") {
        ...
        await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
          ...
          .then(async collected => {
            ...
            if(msg && msg.mentions.channels.filter(ch=>ch.guild.id==msg.guild.id).first()){
              ...
              return message.reply(new Discord.MessageEmbed()
                .setTitle(`<:tick:899255869185855529> I will now send all Youtube Notifications in \`${msg.mentions.channels.filter(ch=>ch.guild.id==msg.guild.id).first().name}\``)
        ...
        if(client.social_log.get(message.guild.id, "youtube.channels").length >= 5) 
          return message.reply(new Discord.MessageEmbed()
            .setTitle("<:cross:899255798142750770>  ERROR | You've reached the maximum amount of youtube Channels (5)")
            .setColor(es.wrongcolor)
...
https://www.youtube.com/channel/UC1AgotpFHNhzolUtAjPgZqQ`)
          ...
          .then(async collected => {
            ...
            if(msg && msg.content ){
              ...
              if(client.social_log.get(message.guild.id, "youtube.channels").includes(msg.content))
                return message.reply(new Discord.MessageEmbed()
                  .setTitle("<:cross:899255798142750770>  ERROR | The Youtube Channel is already setup!")
                  .setColor(es.wrongcolor)
                  .setFooter(es.footertext, es.footericon)
                );
              ...
              return message.reply(new Discord.MessageEmbed()
                .setTitle(`<:tick:899255869185855529> added the Channel ${msg.content}`)
        ...
        if(client.social_log.get(message.guild.id, "youtube.channels").length <= 0) 
          return message.reply(new Discord.MessageEmbed()
            .setTitle("<:cross:899255798142750770>  ERROR | You havent setup any Youtube Channels yet!")
            .setColor(es.wrongcolor)
