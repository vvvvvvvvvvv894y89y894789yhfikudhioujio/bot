    ...
    try {
      ...
      async function first_layer() {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Twitter Setup', 'https://cdn.discordapp.com/emojis/840255600851812393.png?size=96', 'https://discord.gg/hx2wg4HfQS')
          ...
          await tempmsg.channel.awaitMessages({
            ...
            .then(async collected => {
              try {
                ...
                message.reply({
                  embeds: [new Discord.MessageEmbed()
                    .setTitle(`<:Approved:939616742148308992> Set the TWITTER USER ID TO: \`${collected.first().content}\``.substr(0, 256))
                ...
                await tempmsg.channel.awaitMessages({
                  ...
                  .then(async collected => {
                    try {
                      ...
                      return message.reply({
                        embeds: [new Discord.MessageEmbed()
                          .setTitle(`<:Approved:939616742148308992> Set the TWITTER USER Name TO: \`${collected.first().content}\``.substr(0, 256))
...
/**
 * @INFO
 * Bot Coded by S409™#0001 | https://github?.com/ZinkDev/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
