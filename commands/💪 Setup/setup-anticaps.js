    ...
    try {
      ...
      if (temptype == "set") {
          ...
          .then(collected => {
            ...
            if (message.content) {
              ...
              if(userpercent > 100 || userpercent < 0) 
                return message.reply({embed: new Discord.MessageEmbed()
                    .setTitle("<:cross:899255798142750770>  ERROR | Percent out of Range!")
                    .setColor(es.wrongcolor)
              ...
              try {
                ...
                return message.reply({embed: new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> The Anticaps system is now enabled!`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        ...
        try {
          ...
          return message.reply({embed: new Discord.MessageEmbed()
            .setTitle(`<:tick:899255869185855529> The AntiCaps System is now **disabled**`)
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
