    ...
    try {
        ...
        .then(async collected => {
          ...
          if(channel){
            if(!channel.nsfw || channel.nsfw == undefined){
              return message.reply(new Discord.MessageEmbed()
                .setTitle("<:cross:899255798142750770>  ERROR | The Pinged Channel is not a NSFW Channel")
                .setColor(es.wrongcolor)
                .setDescription(`Cancelled the Operation!`.substr(0, 2000))
                .setFooter(es.footertext, es.footericon)
              );
            ...
            return message.reply(new Discord.MessageEmbed()
              .setTitle(`<:tick:899255869185855529> The Channel: \`${channel.name}\` is now registered as the Auto Nsfw Poster Channel`)
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          ...
          return message.reply(new Discord.MessageEmbed()
            .setTitle(`<:tick:899255869185855529> Disabled the Auto Nsfw Poster Channel`)
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<:tick:899255869185855529> Settings of the Auto Nsfw Poster Channel`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
