  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(temptype == "toggle"){
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<:tick:899255869185855529> The Member Counter Setup is now ${d2p(client.setups.get(message.guild.id, `membercount.enabled`))}!`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        ...
        .then(async collected => {
          ...
          if(channel){
            ...
            message.reply(new Discord.MessageEmbed()
              .setTitle(`<:tick:899255869185855529> The Channel: \`${channel.name}\` is now registered as the Member Counter for Counter-${temptype}`)
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
...
*Send the Name NOW!, mind that the Name must be shorter then 32 Characters!!!*`).setFooter(es.footertext, es.footericon)
              ...
              .then(async collected => {
                ...
                if(name && name.length <= 32){
                  ...
                  return message.reply(new Discord.MessageEmbed()
                    .setTitle(`<:tick:899255869185855529> The Channel: \`${channel.name}\` will now be renamed to: \`${name}\``)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
      ...
      if (timeouterror)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<:tick:899255869185855529> Settings of the Member Counter Setup`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
