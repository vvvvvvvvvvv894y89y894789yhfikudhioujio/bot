  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if (temptype == "add") {
          ...
          .then(collected => {
            ...
            if (message.content) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> Added \`${blacklistedwords.length - notadded.length}\` / \`${blacklistedwords.length}\``)
          ...
          .then(collected => {
            ...
            if (message.content) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<:tick:899255869185855529> Removed \`${blacklistedwords.length - notremoved.length}\` / \`${blacklistedwords.length}\``)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<:tick:899255869185855529> Resetted the Blacklist`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter(es.footertext, es.footericon)
        );
      } else {
