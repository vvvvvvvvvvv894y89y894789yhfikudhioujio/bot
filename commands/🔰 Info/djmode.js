  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
        ...
        .addField("<:arrow:899324566927732746> Dj Only Commands active for:", `\`${client.settings.get(message.guild.id, `djonlycmds`).sort(function(a, b){if(a < b) { return -1; }if(a > b) { return 1; }  return 0;}).join("`, `")}\``.substr(0, 1024))
        .addField("<:arrow:899324566927732746> Dj Roles", `${leftb.substr(0, leftb.length-2)}`, true)
