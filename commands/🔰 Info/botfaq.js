...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
      let Zinkdc = client.guilds.cache.get("773668217163218944")
      let Zinkmembers = await Zinkdc.members.fetch().catch(() => {});
      let partnercount = Zinkmembers.filter(m => m.roles.cache.has("823150244509515807"))
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/hx2wg4HfQS")
