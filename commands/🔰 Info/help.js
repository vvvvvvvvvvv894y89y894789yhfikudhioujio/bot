  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("840260133686870036").setLabel("Tutorial").setURL("https://www.youtube.com/c/NotSaksh")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
...
<:Discord:933249753955860490> Made by [**Nexus Development**](https://discord.gg/notsaksh)`)
