...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel('Support Server').setURL("https://discord.com/gg/Zink")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter('Clan Bot | powered by s409.xyz', 'https://imgur.com/jPItIw0.gif')
