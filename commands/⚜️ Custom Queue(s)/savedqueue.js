  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      case `addcurrenttrack`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<:Approved:939616742148308992> Added ${track.title} onto the Queue \`${Name}\``.substr(0, 256))
      ...
      case `removesong`: {
        ...
        //return susccess message
        return message.reply({embeds :[new MessageEmbed()
          .setTitle(`<:Approved:939616742148308992> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substr(0, 256))
      ...
      case `mix`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<:Approved:939616742148308992> Shuffled ${newtracks.length} Tracks of the Queue \`${Name}\``.substr(0, 256))
      ...
      case `removeduplicates`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<:Approved:939616742148308992> Removed ${counter} Tracks from the Queue \`${Name}\``.substr(0, 256))
